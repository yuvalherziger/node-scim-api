...
function sanitizeGroupInput(input) {
...
groupsRouter.get('/Groups', async (req, res) => {
    ...
    const resp = listResponse(base, 'Groups', resources, total, startIndex, count);
...
groupsRouter.post('/Groups', async (req, res) => {
    ...
    if (!body.displayName)
        return sendError(res, 400, 'displayName is required', 'invalidValue');
